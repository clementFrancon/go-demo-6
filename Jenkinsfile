pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          ...
          dir('/home/jenkins/go/src/github.com/clementfrancon/go-demo-6/charts/preview') {
            sh "make preview"
    ...
    stage('Promote to Environments') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/clementfrancon/go-demo-6/charts/go-demo-6') {
